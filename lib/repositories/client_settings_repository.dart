...
class ClientSettingsRepositoryException implements Exception {
  final String message;

  ClientSettingsRepositoryException(this.message);
...
class ClientSettingsRepository {
  ...
  static Future<void> refreshInBackground() async {
    try {
      ...
      debugPrint('Client settings background refresh error: $e');
    }
  }
  ...
  static Future<PlannerSettings> updateNotificationSettings({
    ...
    if (result['success'] != true) {
      throw ClientSettingsRepositoryException(
