...
class PlannerSettingsRepositoryException implements Exception {
  final String message;

  PlannerSettingsRepositoryException(this.message);
...
class PlannerSettingsRepository {
  ...
  static Future<void> refreshInBackground() async {
    try {
      ...
      debugPrint('Planner settings background refresh error: $e');
    }
  }
  ...
  static Future<PlannerSettings> updateNotificationSettings({
    ...
    if (result['success'] != true) {
      throw PlannerSettingsRepositoryException(
